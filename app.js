...
document.write(
	...
	"<style>*{font-family:'Noto Sans TC','Noto Sans JP','Noto Sans SC',serif}*{box-sizing:border-box}body{margin:0;padding:0;background:url(//cdn.jsdelivr.net/gh/NekoChanTaiwan/NekoChan-Open-Data/images/background_2.webp);background-attachment:fixed;background-repeat:no-repeat;background-position:center center;background-size:cover}* .mdui-theme-primary-blue .mdui-color-theme{background-color:#232427!important}* .mdui-appbar{padding-right:8px;padding-left:8px;margin-right:auto;margin-left:auto;max-width:980px}* .mdui-container,.mdui-textfield-input{color:rgba(255,255,255,.87);background-color:rgba(35,36,39,.95);border-width:1px;border-color:#333;border-bottom-style:solid}* .mdui-list li{border-width:1px;border-color:#333;border-bottom-style:solid}.mdui-appbar .mdui-toolbar{height:56px;font-size:1px}.mdui-toolbar>*{padding:0 6px;margin:0 2px}.mdui-toolbar>i{opacity:.5}.mdui-toolbar>.mdui-typo-headline{padding:0 1pc 0 0}.mdui-toolbar>i{padding:0}.mdui-toolbar>a:hover,a.active,a.mdui-typo-headline{opacity:1}.mdui-container{max-width:980px}.mdui-list-item{transition:none}.mdui-list>.th{background-color:initial}.mdui-list-item>a{width:100%;line-height:3pc}.mdui-list-item{margin:2px 0;padding:0}.mdui-toolbar>a:last-child{opacity:1}@media screen and (max-width:980px){.mdui-list-item .mdui-text-right{display:none}.mdui-container{width:100%!important;margin:0}.mdui-toolbar>.mdui-typo-headline,.mdui-toolbar>a:last-child,.mdui-toolbar>i:first-child{display:block}}</style>",
	...
	'<script src="//cdnjs.cloudflare.com/ajax/libs/dplayer/1.26.0/DPlayer.min.js" integrity="sha512-1t2U1/0xGhBZAriD+/9llOhjPs5nFBDZ7KbnHB4SGwAUPrzyS+02Kus1cz0exk5eMyXxwfHxj/1JLuie/p6xXA==" crossorigin="anonymous" async></script>'
)
const Os = {
...
function title(i) {
	...
	let n = window.MODEL
	n.is_search_page
		? $('title').html(`${document.siteName} - ${t} - 搜尋 ${n.q} 的結果`)
...
function append_search_result_to_list(e) {
	...
	for (i in ((html = ''), e)) {
		...
		if (
			...
			let i = 'file',
				e = t.name.split('.').pop().toLowerCase()
			'|html|php|css|go|java|js|json|txt|sh|md|mp4|webm|avi|bmp|jpg|jpeg|png|gif|m4a|mp3|flac|wav|ogg|mpg|mpeg|mkv|rm|rmvb|mov|wmv|asf|ts|flv|'.includes(
				...
				(html += `<li class="mdui-list-item file mdui-ripple" target="_blank"><a id="${t.id}" gd-type="${t.mimeType}" onclick="onSearchResultItemClick(this)" class="${i}">\n\t          <div class="mdui-col-xs-12 mdui-col-sm-7 mdui-text-truncate" title="${t.name}">\n\t          <i class="mdui-icon material-icons">insert_drive_file</i>\n\t            ${t.name}\n\t          </div>\n\t          <div class="mdui-col-sm-3 mdui-text-right">${t.modifiedTime}</div>\n\t          <div class="mdui-col-sm-2 mdui-text-right">${t.size}</div>\n\t          </a>\n\t      </li>`)
		}
	}
