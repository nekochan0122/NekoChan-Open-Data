...
function append_files_to_list(path, files) {
	...
	for (i in files) {
		...
		if (item['mimeType'] == 'application/vnd.google-apps.folder') {
			html += `<a style="text-decoration: none;width: 14.28571%" href="${p}">
				<div style="position: relative; display: inline-block; margin-bottom:50px; padding-right: 4px;">
					<img src="${p}%E5%B0%81%E9%9D%A2.webp">
