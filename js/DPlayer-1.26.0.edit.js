									...
									this.player.template.playedBarWrap.addEventListener(
										...
										function (t) {
											if (e.player.video.duration) {
												var a = e.player.template.playedBarWrap.getBoundingClientRect()
														.left,
												...
												r.isMobile && e.thumbnails && e.thumbnails.show(),
													...
													(e.player.template.playedBarTime.style.left = ''.concat(
														n - (o >= 3600 ? 25 : 20),
														'px'
													)),
													(e.player.template.playedBarTime.innerText = r.secondToTime(
														o
													)),
				...
				function e(t) {
					...
					!(function (e, t) {
						...
						this.player.template.loop.addEventListener('click', function () {
							;(a.player.template.loopToggle.checked = !a.player.template
								.loopToggle.checked),
						...
						this.player.template.showDanmaku.addEventListener(
							'click',
							function () {
								;(a.player.template.showDanmakuToggle.checked = !a.player
						...
						this.player.template.unlimitDanmaku.addEventListener(
							'click',
							function () {
								;(a.player.template.unlimitDanmakuToggle.checked = !a.player
