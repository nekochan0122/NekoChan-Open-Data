!(function (e, t) {
	...
	return (function (e) {
				...
				return new Promise(function (t, p) {
					...
					if (
						(y.open(
							...
							o(f, e.params, e.paramsSerializer),
							!0
						),
						(y.timeout = e.timeout),
			...
			;(function (e) {
				...
				;(s.prototype.catch = function (e) {
					...
					(s.resolve = function (e) {
						return e && 'object' === r(e) && e.constructor === s
							? e
							: new s(function (t) {
									t(e)
							  })
			...
			;(s.prototype.request = function (e) {
				...
				n.forEach(['post', 'put', 'patch'], function (e) {
					s.prototype[e] = function (t, a, r) {
						return this.request(
							n.merge(r || {}, { method: e, url: t, data: a })
						)
					}
				}),
				(e.exports = s)
			...
			e.exports = function (e) {
				return (
					...
					(e.adapter || i.adapter)(e).then(
						function (t) {
							return (
								l(e), (t.data = r(t.data, t.headers, e.transformResponse)), t
							)
						},
						function (t) {
							return (
		...
		function (e, t, a) {
												...
												var o = n / s(r),
													d = function (r) {
														...
														for (var p = 0; p < d.length; p++) {
															var c = l(d[p]) - 10
															if (
																c <= n - o * s(parseInt(d[p].style.width)) ||
																c <= 0
															)
																break
															if (p === d.length - 1)
																return (
																	t.danTunnel[a][r + ''].push(e),
																	e.addEventListener(
																		'animationend',
																		function () {
																			t.danTunnel[a][r + ''].splice(0, 1)
										...
										var p = document.createDocumentFragment(),
											c = function (r) {
												...
												switch (e[r].type) {
													...
													default:
														console.error(
															"Can't handled danmaku type: ".concat(e[r].type)
														)
												}
												s >= 0 &&
					...
					(a = [
						...
						},
						{
							...
							value: function () {
								...
								switch (
									(a || (this.lastScrollPosition = o.getScrollPosition()), e)
								) {
									case 'browser':
								...
								var e = this,
									t = function (t) {
										...
										;(a = Math.max(a, 0)),
											...
											(e.player.template.ptime.innerHTML = o.secondToTime(
										...
										function (t) {
											if (e.player.video.duration) {
												...
												o.isMobile && e.thumbnails && e.thumbnails.show(),
													...
													(e.player.template.playedBarTime.innerText = o.secondToTime(
														r
													)),
				...
				function e(t) {
					...
					for (
						var n = function (e) {
							...
							r = 0;
						r < this.player.template.speedItem.length;
						r++
					)
						n(r)
								...
								if (
									...
									switch (o.keyCode) {
										...
										case 39:
											...
											break
										case 38:
											o.preventDefault(), (r = t.volume() + 0.1), t.volume(r)
											break
										case 40:
											o.preventDefault(), (r = t.volume() - 0.1), t.volume(r)
									}
					...
					return (
						...
						(a = [
							...
							},
							{
								...
								value: function (e) {
									...
									if (
										...
										this.video.paused &&
											!o.isMobile &&
											this.bezel.switch(U.play),
										(this.template.playButton.innerHTML = U.pause),
										(this.template.mobilePlayButton.innerHTML = U.pause),
										e ||
											n.a
							...
							},
							{
								...
								value: function () {
									this.volume() >= 0.95
										? (this.template.volumeIcon.innerHTML = U.volumeUp)
										: this.volume() > 0
										? (this.template.volumeIcon.innerHTML = U.volumeDown)
										: (this.template.volumeIcon.innerHTML = U.volumeOff)
								},
							},
							{
								key: 'volume',
											...
											case 'flv':
												if (window.flvjs)
													if (window.flvjs.isSupported()) {
														var o = Object.assign(
																this.options.pluginOptions.flvjs,
																{ type: 'flv', url: e.src }
															),
								...
								value: function (e, t) {
									...
									this.initMSE(e, t),
										this.on('durationchange', function () {
											1 !== e.duration &&
												e.duration !== 1 / 0 &&
												(a.template.dtime.innerHTML = o.secondToTime(
													e.duration
												))
										}),
									...
									for (
										var n = function (t) {
											...
											r = 0;
										r < this.events.videoEvents.length;
										r++
									)
										n(r)
									this.volume(this.user.get('volume'), !0, !0),
										this.options.subtitle &&
											((this.subtitle = new ie(
								...
								value: function (e) {
									...
									if (
										...
										var n = Ye()({
											...
											r = new DOMParser().parseFromString(n, 'text/html').body
												.firstChild
			...
			console.log(
				'\n'
					.concat(' %c DPlayer v', '1.25.1', ' ')
					.concat('e3a4631', ' %c http://dplayer.js.org ', '\n', '\n'),
